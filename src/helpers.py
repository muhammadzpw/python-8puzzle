def calc_distance(stateA: str, stateB: str): 
...
def find_space_position(input: str):
  return input.index('#')

def is_possible_up(input: str):
  space_position = find_space_position(input)
  if space_position in [0, 1, 2]:
    return False
  return True

def is_possible_left(input: str):
  space_position = find_space_position(input)
  if space_position in [0, 3, 6]:
    return False
  return True

def is_possible_right(input: str):
  space_position = find_space_position(input)
  if space_position in [2, 5, 8]:
    return False
  return True

def is_possible_down(input: str):
  space_position = find_space_position(input)
  if space_position in [6, 7, 8]:
    return False
  return True

def is_move_possible(move, input):
  if move == "up":
...
def switch_position(input: str, idx: int, switch_idx: int):
  output = list(input)
